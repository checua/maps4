...
[System.IO.File]::WriteAllText($migrationPath, $migration, $utf8NoBom)

Write-Host 'Fixed sql/RSMaps2/45_radar_terminal_workflow_ack.sql for same-batch SQL Server compilation.'
Write-Host 'A and B must remain stopped until the migration is executed successfully.'
